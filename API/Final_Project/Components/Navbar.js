const navbar_Components = () => {
  ...
  <div class="container">
    <a class="navbar-brand me-auto" href="/Local Storage/index.html">Logo</a>
    <div
        ...
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          <li class="nav-item">
            <a
              ...
              aria-current="page"
              href="/API/Final_Project/index.html"
              >Home</a
            >
          </li>
          <li class="nav-item">
            <a
              ...
              href="/API/Final_Project/HTML/Product.html"
              >Product</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link active mx-lg-2"
              href="/API/Final_Project/HTML/Add_Product.html"
              >Product Form</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link active mx-lg-2"
              href="/API/Final_Project/HTML/CartPage.html"
              >Cart</a
            >
          </li>
          <li class="nav-item">
    ...
    <a href="/API/Final_Project/HTML/Login.html" class="login-button mx-1"
      >Login</a
    >
    <a class="login-button mx-1" href="/API/Final_Project/HTML/Signup.html"
      >Sign Up</a
    >
    <button
    ...
    >
      <span><img src="/API/Final_Project/Images/menu-bar.png" alt="" /></span>
    </button>
  </div>
</nav>`;
};
