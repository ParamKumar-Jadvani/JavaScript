const navbar_Components = (isLogin = false) => {
  return `<nav class="navbar navbar-expand-lg fixed-top">
          <div class="container">
            ...
            >
              <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarLabel">
                  <a href="/API/Json_Project/index.html">Logo</a>
                </h5>
                <button
                  type="button"
                  class="btn-close"
                ...
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                  <li class="nav-item">
                    <a
                      ...
                      aria-current="page"
                      href="/API/Json_Project/index.html"
                      >Home</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      ...
                      href="/API/Json_Project/HTML/Product.html"
                      >Product</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link active mx-lg-2"
                      href="/API/Json_Project/HTML/Add_Product.html"
                      >Product Form</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link active mx-lg-2"
                      href="/API/Json_Project/HTML/CartPage.html"
                      >Cart</a
                    >
                  </li>
                  <li class="nav-item">
            ...
            >
              <span
                ><img src="/API/Json_Project/Images/menu-bar.png" alt=""
              /></span>
            </button>
          </div>
        </nav>`;
